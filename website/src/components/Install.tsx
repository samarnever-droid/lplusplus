...
const TABS = [
  {
    ...
    copy: "irm https://lplusplus.bond/install.ps1 | iex",
    lines: [
      { p: "PS>", t: "irm https://lplusplus.bond/install.ps1 | iex", c: "text-white" },
      { p: "", t: "  [1/3] downloading lpp-windows-x86_64.zip ... ok", c: "text-white/45" },
      { p: "", t: "  [2/3] unpacking compiler and linker ........ ok", c: "text-white/45" },
      { p: "", t: "  [3/3] adding ~/.lpp/bin to user PATH ....... ok", c: "text-white/45" },
      { p: "", t: "", c: "" },
      { p: "PS>", t: "lpp upgrade --check", c: "text-white" },
      { p: "", t: "L++ Compiler v4.7.0 (Production Release)", c: "text-acid" },
    ],
  },
  {
    id: "unix",
    label: "macOS / Linux",
    copy: "curl -fsSL https://lplusplus.bond/install.sh | bash",
    lines: [
      { p: "$", t: "curl -fsSL https://lplusplus.bond/install.sh | bash", c: "text-white" },
      { p: "", t: "  [1/3] downloading lpp binary asset from CDN . ok", c: "text-white/45" },
      { p: "", t: "  [2/3] installing to ~/.lpp/bin ............. ok", c: "text-white/45" },
      { p: "", t: "  [3/3] configuring shell profile PATH ....... ok", c: "text-white/45" },
      { p: "", t: "", c: "" },
      { p: "$", t: "lpp upgrade --check", c: "text-white" },
      { p: "", t: "L++ Compiler v4.7.0 (Production Release)", c: "text-acid" },
    ],
  },
  {
    id: "cargo",
    label: "Cargo / Source",
    copy: "cargo install --git https://github.com/samarnever-droid/lplusplus --force",
    lines: [
      { p: "$", t: "cargo install --git https://github.com/samarnever-droid/lplusplus --force", c: "text-white" },
      { p: "", t: "  compiling cranelift-codegen ................ ok", c: "text-white/45" },
      { p: "", t: "  compiling lpp v4.7.0 release binary ........ ok", c: "text-white/45" },
      { p: "", t: "  installed package `lpp v4.7.0` (executable `lpp`)", c: "text-acid" },
    ],
  },
];
