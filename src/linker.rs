...
fn is_kernel32_symbol(name: &str) -> bool {
    ...
    matches!(
        ...
        "ExitProcess" | "GetTickCount64" | "LoadLibraryA" | "LoadLibraryW" | "FreeLibrary" | "GetProcAddress"
            ...
            | "InitializeCriticalSection" | "EnterCriticalSection" | "TryEnterCriticalSection" | "LeaveCriticalSection"
            | "DeleteCriticalSection" | "InitializeSRWLock" | "AcquireSRWLockExclusive" | "ReleaseSRWLockExclusive"
            ...
            | "GetCurrentThread" | "GetCurrentThreadId" | "GetExitCodeThread" | "SwitchToThread" | "ResumeThread" | "SetThreadAffinityMask"
