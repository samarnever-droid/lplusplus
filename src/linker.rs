...
pub fn write_elf_with_options(
    ...
    let etype: u16 = if pie || opts.shared { 3 } else { 2 }; // ET_DYN / ET_EXEC
...
fn is_kernel32_symbol(name: &str) -> bool {
    ...
    matches!(
        ...
        "ExitProcess" | "GetTickCount64" | "LoadLibraryA" | "LoadLibraryW" | "FreeLibrary" | "GetProcAddress"
            ...
            | "CreateProcessA" | "GetExitCodeProcess" | "GetExitCodeThread" | "SwitchToThread" | "ResumeThread" | "SuspendThread" | "TerminateThread" | "CreatePipe" | "GetEnvironmentVariableA"
            ...
            | "InitializeCriticalSection" | "InitializeCriticalSectionAndSpinCount" | "EnterCriticalSection" | "TryEnterCriticalSection" | "LeaveCriticalSection"
            | "DeleteCriticalSection" | "InitializeSRWLock" | "AcquireSRWLockShared" | "AcquireSRWLockExclusive"
            | "ReleaseSRWLockShared" | "ReleaseSRWLockExclusive" | "SetThreadAffinityMask" | "GetCurrentThread"
