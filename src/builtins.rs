...
pub fn get_builtins() -> &'static [Builtin] {
    static BUILTINS: &[Builtin] = &[
        ...
        Builtin {
            ...
            params: &[
                ParamType::Specific(TypeRef::VectorI64x2),
                ParamType::Specific(TypeRef::VectorI64x2),
            ],
            return_type: TypeRef::VectorI64x2,
            cl_params: &[0, 0],
        ...
        Builtin {
            name: "lpp_c_store_i32",
            symbol: "lpp_c_store_i32",
            params: &[
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
        ...
        Builtin {
            name: "lpp_c_store_i64",
            symbol: "lpp_c_store_i64",
            params: &[
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
        ...
        Builtin {
            ...
            symbol: "lpp_atomic_load_relaxed",
            params: &[ParamType::Specific(TypeRef::Int)],
            return_type: TypeRef::Int,
            cl_params: &[0],
            cl_return: Some(0),
        ...
        Builtin {
            ...
            symbol: "lpp_atomic_store_relaxed",
            params: &[
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
            ],
        ...
        Builtin {
            name: "atomic_cas_weak",
            symbol: "lpp_atomic_cas_weak",
            params: &[
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
                ParamType::Specific(TypeRef::Int),
        ...
        Builtin {
            name: "atomic_fence_acq",
            symbol: "lpp_atomic_fence_acq",
            params: &[],
            return_type: TypeRef::Void,
            cl_params: &[],
            cl_return: None,
        ...
        Builtin {
            name: "atomic_fence_rel",
            symbol: "lpp_atomic_fence_rel",
            params: &[],
            return_type: TypeRef::Void,
            cl_params: &[],
            cl_return: None,
        ...
        Builtin {
            name: "rwlock_rdunlock",
            symbol: "lpp_rwlock_rdunlock",
            params: &[ParamType::Specific(TypeRef::Int)],
            return_type: TypeRef::Void,
            cl_params: &[0],
            cl_return: None,
        ...
        Builtin {
            name: "rwlock_wrunlock",
            symbol: "lpp_rwlock_wrunlock",
            params: &[ParamType::Specific(TypeRef::Int)],
            return_type: TypeRef::Void,
            cl_params: &[0],
            cl_return: None,
        ...
        Builtin {
            name: "list_binary_search",
            symbol: "lpp_list_binary_search",
            params: &[ParamType::Any, ParamType::Specific(TypeRef::Int)],
            return_type: TypeRef::Int,
            cl_params: &[0, 0],
            cl_return: Some(0),
