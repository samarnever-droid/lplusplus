...
static lpp__env_0_t* lpp__cur_env_0 = NULL;

static int64_t lpp__fn_0(lpp__env_0_t* __env, int64_t y_2) {
    int64_t x_1 = __env->x_1;
    return (x_1 + y_2);
}

static int64_t lpp__trampoline_0(int64_t y_2) {
    return lpp__fn_0(lpp__cur_env_0, y_2);
}
...
typedef struct __lpp_closure_env_2 __lpp_closure_env_2_t;
struct __lpp_closure_env_2 {
    int64_t cap_0;
};
...
void lpp_main(void) {
    ...
    int64_t x_1 = 42;
    /* Storage: Value */
    lpp__env_0_t* __lpp_env_0 = (lpp__env_0_t*)malloc(sizeof(lpp__env_0_t));
    __lpp_env_0->x_1  = x_1;
    lpp__cur_env_0 = __lpp_env_0;
    int64_t my_closure_3 = lpp__trampoline_0;
    /* Storage: Value */
    int64_t val_4 = my_closure_3(10);
    printf("%lld\n", (long long)(val_4));
}
