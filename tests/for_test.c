...
void lpp_main(void) {
    lpp_print_str("--- For Loop Syntactic Sugar Test ---");
    /* Storage: Value */
    void* l_1 = lpp_list_new();
    lpp_list_push(l_1, 10);
    lpp_list_push(l_1, 20);
    lpp_list_push(l_1, 30);
    /* Storage: Value */
    void* __lpp_for_list_56_2 = l_1;
    /* Storage: Value */
    int64_t __lpp_for_idx_56_3 = 0;
    while ((__lpp_for_idx_56_3 < lpp_list_len(__lpp_for_list_56_2))) {
        /* Storage: Value */
        int64_t x_4 = lpp_list_get(__lpp_for_list_56_2, __lpp_for_idx_56_3);
        printf("%lld\n", (long long)(x_4));
        __lpp_for_idx_56_3 = (__lpp_for_idx_56_3 + 1);
    }
    lpp_list_free(l_1);
    lpp_print_str("--- Success ---");
}
