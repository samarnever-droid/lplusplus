...
void lpp_main(void) {
    /* Storage: Value */
    char* path_1 = "test_file.txt";
    /* Storage: Value */
    int ex1_2 = lpp_file_exists(path_1);
    if (ex1_2) {
        lpp_print_str("exists before: 1");
    } else {
        lpp_print_str("exists before: 0");
    }
    /* Storage: Value */
    int64_t w_res_3 = lpp_write_file(path_1, "Hello ");
    printf("%lld\n", (long long)(w_res_3));
    /* Storage: Value */
    int ex2_4 = lpp_file_exists(path_1);
    if (ex2_4) {
        lpp_print_str("exists after write: 1");
    } else {
        lpp_print_str("exists after write: 0");
    }
    /* Storage: Value */
    int64_t a_res_5 = lpp_append_file(path_1, "World!");
    printf("%lld\n", (long long)(a_res_5));
    /* Storage: Value */
    char* content_6 = lpp_read_file(path_1);
    lpp_print_str(content_6);
    /* Storage: Value */
    int64_t d_res_7 = lpp_delete_file(path_1);
    printf("%lld\n", (long long)(d_res_7));
    /* Storage: Value */
    int ex3_8 = lpp_file_exists(path_1);
    if (ex3_8) {
        lpp_print_str("exists after delete: 1");
    } else {
        lpp_print_str("exists after delete: 0");
    }
}
