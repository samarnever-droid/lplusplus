...
void lpp_main(void) {
    lpp_print_str("=== Testing 15 New L++ Standard Builtins ===");
    /* Storage: Value */
    char* s1_1 = "Hello";
    /* Storage: Value */
    char* s2_2 = "World";
    /* Storage: Value */
    char* greeting_3 = lpp_str_concat(s1_1, " ");
    /* Storage: Value */
    char* full_greeting_4 = lpp_str_concat(greeting_3, s2_2);
    lpp_print_str("1. Concat result:");
    lpp_print_str(full_greeting_4);
    /* Storage: Value */
    char* test_dir_5 = "lpp_test_demo_folder";
    lpp_print_str("2. Creating directory...");
    lpp_dir_create(test_dir_5);
    /* Storage: Value */
    int64_t exists_6 = lpp_path_exists(test_dir_5);
    lpp_print_str("3. Path exists check:");
    printf("%lld\n", (long long)(exists_6));
    lpp_print_str("4. Command Output (hostname):");
    /* Storage: Value */
    char* out_7 = lpp_command_output("hostname");
    lpp_print_str(out_7);
    lpp_dir_remove(test_dir_5);
    lpp_print_str("5. Cleaned up test folder!");
    lpp_print_str("=== All 15 New Builtins Functioning 100%! ===");
}
